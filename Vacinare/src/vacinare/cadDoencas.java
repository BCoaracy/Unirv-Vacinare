 ...
 * @author Bruno
 */
public class cadDoencas extends javax.swing.JFrame {

    /**
     * Creates new form cadDoencas
     */
    public cadDoencas() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cadDoencas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cadDoencas().setVisible(true);
            }
        });
    }
